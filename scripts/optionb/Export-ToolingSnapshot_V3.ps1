...
.NOTES
  Script-Version: V3
  Diese Datei ist die dritte, parallel gefuehrte Version von Export-ToolingSnapshot.ps1.

.EXAMPLE
  powershell -ExecutionPolicy Bypass -File .\Export-ToolingSnapshot_V3.ps1

.EXAMPLE
  powershell -ExecutionPolicy Bypass -File .\Export-ToolingSnapshot_V3.ps1 -RepoPath "D:\Git\ASWE_KnowledgeOS" -Project "AgenticSWE_KnowledgeOS"

.EXAMPLE
  powershell -ExecutionPolicy Bypass -File .\Export-ToolingSnapshot_V3.ps1 -OutDir "D:\Git\ASWE_KnowledgeOS\meta\state\tooling"
#>
