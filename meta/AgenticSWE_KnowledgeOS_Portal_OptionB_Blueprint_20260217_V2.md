...
# Option B Blueprint: ChatGPT im Portal/Keystatic, schreibt per PR (V2)
...
- `meta/meta/AgenticSWE_KnowledgeOS_Glossary_20260217_V6.md` (normative Begriffe)
- `meta/meta/meta/AgenticSWE_KnowledgeOS_Taxonomy_20260217_V2.md` (normative Tags + Regeln)
...
**P0 (Sofort):**
- `meta/meta/AgenticSWE_KnowledgeOS_Taxonomy_20260217_V2.md` (Patch: templates-harness mapping fix)
