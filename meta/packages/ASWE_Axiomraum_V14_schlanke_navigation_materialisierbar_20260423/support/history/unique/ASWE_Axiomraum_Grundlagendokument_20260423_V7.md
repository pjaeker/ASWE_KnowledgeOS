---
document_id: ASWE_Axiomraum_Grundlagendokument_20260423_V7
document_role: repo_materialisierbares_grundlagendokument
status: foundation_candidate_with_pruefartefakt_layer
...
# ASWE_Axiomraum_Grundlagendokument_20260423_V7
...
## 11. Verhaeltnis von definitorischer Schicht, Pruefartefakten, Pruefstandard und Routinen
...
Der rekursive Pruefstandard ist ein **Pruefartefakt** in Form eines allgemeinen Pruefschemas. Er stellt Fragen an Elemente, darf die Elementtypen aber nicht selbst definieren oder umdeuten.

Die Routinen sind **Pruefartefakte** in Form konkreter Pruef- und Aenderungsablaeufe. Sie wenden den Pruefstandard in bestimmten Faellen an: Neuaufnahme, Umklassifizierung, Axiomrevision und Gesamt-Konsistenzaudit.
...
Pruefstandard
  -> allgemeines Pruefartefakt; fragt jedes Element nach Funktion, Rueckbindung, Trennschaerfe, Konfliktlage und Entscheidung

Pruefroutine
  -> konkretes Pruefartefakt; legt Anlass, Reihenfolge und Suchspur einer Anwendung fest
```
...
```text
Definitorische Mindestschicht -> Pruefstandard -> Pruefroutine -> Pruefurteil
```
...
Operative Regeln sind Raumelemente. Routinen sind Pruefartefakte als Meta-Verfahren am Raumelementbestand.

```text
operative Regel = ausfuehrbares Element im Axiomraum
Pruefroutine    = Verfahren zur Pruefung oder Veraenderung des Axiomraums
```

### 11.5 Verhaeltnis zum Gesamt-Konsistenzaudit

Der Gesamt-Konsistenzaudit ist eine Pruefroutine. Er ist kein einzelnes Pruefkriterium, kein Pruefstandard und kein Raumelement. Er wendet den Pruefalgorithmus auf den gesamten Elementbestand an, um Typreinheit, Rueckbindung, Ableitungsrichtung, Zirkularitaetsfreiheit und Ebenenreinheit zu pruefen.
