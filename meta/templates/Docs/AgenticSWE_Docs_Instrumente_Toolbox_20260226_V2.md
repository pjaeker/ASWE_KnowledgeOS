...
audience:
  - human
  - llm
intent: "Katalog an verständnisfördernden Instrumenten (elements; building blocks) für Diátaxis-Dokumente: Leitfragen, Visualisierungen, Tabellen, Callouts, Checks. Enthält Auswahlmatrix und Default-Sets pro Dokumenttyp."
tags:
  - layer/handbook
  - artifact/reference
  - topic/diataxis
...
- Intended path: `handbook/reference/AgenticSWE_Docs_Instrumente_Toolbox_20260226_V2.md`
