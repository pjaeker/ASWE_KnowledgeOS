...
status: draft
audience: [human, llm]
intent: "Fortschreibbarer Verlauf der Skill-Entwicklung fuer Session-Init und Session-Closeout. Ergaenzt den Closeout-Skill um den expliziten Artefaktentscheid fuer den Closeout-Writingslice."
---
