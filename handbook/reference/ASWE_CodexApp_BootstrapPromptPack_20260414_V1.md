...
status: draft
audience: [human, llm]
intent: "Praeziser Prompt-Satz fuer den lueckenlosen Evidence-Intake-Selbstevolutionsstart in der Codex App."
tags:
  - layer/handbook
  - artifact/reference
  - topic/codex
...
Fuehrende Kette:
ENTRY_LATEST -> RepoStatusUpdate -> ASWE_WS_ArchitectureEvolution -> ASWE_WS_EvidenceIntake -> ASWE_CodexApp_StartContract_20260414_V1 -> ASWE_CodexApp_AutonomousStart_E2E_20260414_V1.
...
- live Internet nur bounded und dokumentiert
```
...
7. G0 als pass oder return ausweisen
```
...
```text
Arbeite als zeitgesteuerte bounded Automation.
Lies nur Queue-/Ledger-/Gate-/Resume-Zustand aus benannten K5-Flaechen.
Du darfst vorbereiten, verdichten und Run Records schreiben.
