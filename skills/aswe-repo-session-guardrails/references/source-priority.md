...
Nutze standardmaessig nur GitHub-nahe Primarquellen. Andere Konnektoren oder externe Quellen sind nur zulaessig, wenn der Nutzer sie explizit anfordert.
...
- ein aelteres Planungsdokument darf keinen bereits bestaetigten neueren Session-Stand verdrängen
...
- den zuletzt hoeherwertig bestaetigten Stand beibehalten
- neue Ableitungen als vorlaeufig markieren
- klar sagen, welche Verifikation fehlt

### Empfohlene Formulierung

> Der aktuelle Repo-Stand konnte nicht robust aus GitHub-naher Primaerevidenz verifiziert werden. Ich halte daher den zuletzt hoeherwertig bestaetigten Session-Stand bei und markiere neue Ableitungen als vorlaeufig.
